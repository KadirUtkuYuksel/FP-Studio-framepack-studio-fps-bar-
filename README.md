...
3) Right-click the ZIP → Extract All… into the Frampack Studio folder.
4) Open the extracted `fps_feature_files` folder and run:
```powershell
...
# Change into extracted folder (adjust name if different), then run batch
