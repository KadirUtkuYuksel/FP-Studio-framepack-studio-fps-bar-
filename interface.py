    ...
    with block:
                    ...
                    with gr.Column(scale=2):
                        ...
                        with gr.Accordion("Basic Parameters", open=True, visible=True) as basic_parameters_accordion:
                            with gr.Group():
                                ...
                                with gr.Row("FPS Selection"):
                                    fps_selection = gr.Slider(
                                        minimum=16,
                                        maximum=30,
                                        step=1,
                                        value=30,
                                        label="Output FPS",
                                        info="Select the frame rate for the generated video (16-30 FPS)"
                                    )
        ...
        def process_with_queue_update(model_type_arg, *args):
            ...
            (input_image_arg,
             ...
             fps_selection_arg, # the FPS selection value
            ...
            result = process_fn(backend_model_type, input_data, actual_end_frame_image_for_backend, actual_end_frame_strength_for_backend,
                                ...
                                fps_selection_arg, latent_window_size_arg, steps_arg, cfg_arg, gs_arg, rs_arg,
        ...
        ips = [
            ...
            fps_selection,              # Corresponds to fps_selection_arg
